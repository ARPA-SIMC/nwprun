# RADAR for LHN
ARKI_LHN_DS=$ARKI_URL/dataset/COSMO_IT2_RADAR
#RADAR_LHN_GP=10
MODEL_LHN=.FALSE.
...
PARENTMODEL_ARKI_DS=$ARKI_URL/dataset/IFS_ME
...
ARKI_DS_ASSIM=$ARKI_URL/dataset/COSMO_IT2_ASSIM
ARKI_DS_FCAST=$ARKI_URL/dataset/COSMO_IT2_FCAST
ARKI_DS_INTER=$ARKI_URL/dataset/COSMO_IT2_INTER
MODEL_ASSIM_GP=11
MODEL_FCAST_GP=12
MODEL_INTER_GP=13
