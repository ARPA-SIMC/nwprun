...
defaults = [
    ...
    [ 0.7, 2.1, 4.0, 6.4, 9.7, 15.0 ],
    [ 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 7.0, 9.0, 11.0, 13.5, 16.0 ],
    [ 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 7.0, 9.0, 11.0, 15.0, 16.0 ],
    [ 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 7.0, 9.0, 11.0, 13.9, 16.0 ],
    [ 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 7.0, 9.0, 11.0, 14.1, 16.0 ],
    [ 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 7.0, 9.0, 11.0, 14.3, 16.0 ],
    [ 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 7.0, 9.0, 11.0, 14.5, 16.0 ],
    [ 0.5, 1.5, 2.5, 3.5, 4.5, 7.0, 9.0, 11.0, 13.5, 16.0 ],
    ...
    [ 0.5, 1.5, 2.5, 3.5 ],
    [ 0.6, 1.4, 2.4, 3.4 ],
    [ 0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5, 4.0, 5.0, 6.0, 8.0, 14.0 ], 
