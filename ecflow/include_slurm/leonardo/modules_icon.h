...
export LD_LIBRARY_PATH=$WORKDIR_BASE_OPE/srcintel/eccodes-2.32.0/lib64:$WORKDIR_BASE_OPE/srcintel/install/lib:$LD_LIBRARY_PATH
export PATH=$WORKDIR_BASE_OPE/srcintel/eccodes-2.32.0/bin:$WORKDIR_BASE_OPE/srcintel/install/bin:$PATH
